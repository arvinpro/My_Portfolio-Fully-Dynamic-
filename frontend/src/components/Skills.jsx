...
function Skills() {
  ...
  const skills = [
    { name: 'HTML5', icon: 'html5/html5-original.svg', color: 'from-orange-500 to-red-500' },
    { name: 'CSS3', icon: 'css3/css3-original.svg', color: 'from-blue-500 to-indigo-500' },
    { name: 'JavaScript', icon: 'javascript/javascript-original.svg', color: 'from-yellow-500 to-orange-500' },
    { name: 'TypeScript', icon: 'typescript/typescript-original.svg', color: 'from-blue-600 to-blue-800' },
    { name: 'React.js', icon: 'react/react-original.svg', color: 'from-cyan-500 to-blue-500' },
    { name: 'Next.js', icon: 'nextjs/nextjs-original.svg', color: 'from-gray-800 to-gray-900' },
    { name: 'Tailwind', icon: 'tailwindcss/tailwindcss-plain.svg', color: 'from-teal-500 to-cyan-500' },
    { name: 'Node.js', icon: 'nodejs/nodejs-original.svg', color: 'from-green-500 to-green-700' },
    { name: 'Express', icon: 'express/express-original.svg', color: 'from-gray-600 to-gray-800' },
    { name: 'MongoDB', icon: 'mongodb/mongodb-original.svg', color: 'from-green-600 to-green-800' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Here are the technologies and tools I work with regularly to build modern, responsive applications
              with cutting-edge performance and user experience.
            </p>
          </div>
              ...
              {skills.map((skill, index) => (
                ...
                >
                  ...
                  <div className="relative p-4 sm:p-5 lg:p-6 bg-white/10 dark:bg-gray-800/30 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 min-h-[120px] sm:min-h-[140px] lg:min-h-[160px] flex flex-col items-center justify-center border border-white/20 hover:border-purple-400/50">
                    ...
                    {/* Glow Effect */}
                    <div className={`absolute inset-0 bg-gradient-to-r ${skill.color} opacity-0 group-hover:opacity-20 rounded-2xl transition-opacity duration-500 blur-xl`} />
                    ...
                    <div className="relative z-10 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 flex items-center justify-center mb-2 sm:mb-3">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          fallback.className = 'w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center text-white font-bold text-xs sm:text-sm';
            ...
            <div className="space-y-6 sm:space-y-8">
              {[
                ...
                },
                {
                  label: 'UI/UX Design',
                  percent: '78%',
                  description: 'Responsive Design, User Experience, Modern Interfaces',
                  color: 'from-purple-500 to-pink-600'
                },
                {
                  label: 'TypeScript & Next.js',
                  percent: '88%',
                  description: 'Type Safety, Server-Side Rendering, Modern Development',
                ...
                <div key={label} className="group">
                  ...
                  <div className="relative">
                    ...
                    <div className={`absolute top-0 left-0 h-3 bg-gradient-to-r ${color} rounded-full blur-sm opacity-30 transition-all duration-1000 ease-out`}
                         style={{ width: '0%' }}
                         data-width={percent} />
                  </div>
                </div>
