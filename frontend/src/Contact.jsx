      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Let's work together! Feel free to reach out for any project or collaboration
          </p>
        </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm text-gray-400 group-hover/contact:text-gray-300 transition-colors">Phone</p>
                          <p className="text-white font-medium group-hover/contact:text-purple-200 transition-colors">+977-9861140141</p>
                        </div>
                      </a>
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm text-gray-400 group-hover/contact:text-gray-300 transition-colors">Email</p>
                          <p className="text-white font-medium group-hover/contact:text-purple-200 transition-colors">jimdar900@gmail.com</p>
                        </div>
                      </a>
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm text-gray-400 group-hover/contact:text-gray-300 transition-colors">GitHub</p>
                          <p className="text-white font-medium group-hover/contact:text-purple-200 transition-colors">arvinpro</p>
                        </div>
                      </a>
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm text-gray-400 group-hover/contact:text-gray-300 transition-colors">WhatsApp</p>
                          <p className="text-white font-medium group-hover/contact:text-green-200 transition-colors">Message me</p>
                        </div>
                      </a>
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm text-gray-400 group-hover/contact:text-gray-300 transition-colors">LinkedIn</p>
                          <p className="text-white font-medium group-hover/contact:text-blue-200 transition-colors">arvinjm04</p>
                        </div>
                      </a>
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm text-gray-400 group-hover/contact:text-gray-300 transition-colors">Telegram</p>
                          <p className="text-white font-medium group-hover/contact:text-sky-200 transition-colors">@arvinpro</p>
                        </div>
                      </a>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleformSubmit} className="space-y-5 sm:space-y-6">
                    ...
                    <div className="group/input">
                      ...
                      <div className="relative">
                        ...
                        {/* Input glow effect */}
                        <div className={`absolute inset-0 rounded-2xl opacity-0 group-hover/input:opacity-100 transition-opacity duration-300 -z-10 blur-md ${
                          errors.name && touched.name
                            ? 'bg-red-500/20'
                            : !errors.name && touched.name
                            ? 'bg-green-500/20'
